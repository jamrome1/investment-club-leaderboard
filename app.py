...
p1_data = calculate_period_leaderboard("Meeting_1", PERIODS["Meeting 1_to_2"]["start"], PERIODS["Meeting 1_to_2"]["end"], PORTFOLIO_MAP["Meeting 1_to_2"])

p2_data = calculate_period_leaderboard("Meeting_2", PERIODS["Meeting 2_to_3"]["start"], PERIODS["Meeting 2_to_3"]["end"], PORTFOLIO_MAP["Meeting 2_to_3"])
